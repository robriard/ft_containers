...
/*   Updated: 2021/12/28 10:33:51 by unknow           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
    ...
    class vector {
        public:
            ...
            vector (const vector& x) : _allocator(x._alloc), _size(x._size), _capacity(x._capacity) {
				if (this->_capacity)
					this->_vector = this->_allocator.allocate(this->_capacity);
            ...
            reference at (size_type n) {
                if (n > this->max_size()) throw std::out_of_range("vector::at");
