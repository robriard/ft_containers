...
/*   Updated: 2022/01/25 11:06:00 by unknow           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#ifndef STD
# define NAMESPACE ft
# define BUF static_cast<std::string>("FT")
#else
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 0\n";
	else std::cout << "STD test 0\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 1\n";
	else std::cout << "STD test 1\n";
...
void	insert_tests()
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 2\n";
	else std::cout << "STD test 2\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 3\n";
	else std::cout << "STD test 3\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 4\n";
	else std::cout << "STD test 4\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 5\n";
	else std::cout << "STD test 5\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 6\n";
	else std::cout << "STD test 6\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 7\n";
	else std::cout << "STD test 7\n";
...
{
	if (BUF == static_cast<std::string>("FT")) std::cout << "FT test 8\n";
	else std::cout << "STD test 8\n";
